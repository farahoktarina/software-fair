...
<head>
    ...
    <title>SOFTWARE FAIR 2017</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Login Developer</h3>
                    </div>
                    ...
                    <p style="color: red;">
                        ...
                        <form role="form" method="post" action="<?php echo site_url('developer/login_dev');?>">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Email" name="email_dev" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="password_dev" type="password">
                                </div>
                                <input type="submit" value="Login" name="" class="btn btn-success btn-lg btn-block">
                            </fieldset>
                        </form>
