		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="section-title">
					<h1 class="heading bold">ABOUT SOFTWARE FAIR</h1>
					<hr>
				</div>
			</div>
...
<section id="team" style="background-color: #3B3B3B;">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="section-title">
					<h1 class="heading bold" style="color:white">APPLICATIONS</h1>
					<hr>
				</div>
			</div>
...
<!-- pricing section -->
<section id="pricing" style="background-color: #3B3B3B; color:white">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 text-center">
				<div class="section-title">
					<h1 class="heading bold">TIMELINE</h1>
					<hr>
				</div>
			</div>
			<div class="col-lg-12">
